...
// ── Mock events (mirrors calendar_events table) ───────────────────────────────

const INITIAL_EVENTS: CalEvent[] = [
  { id: 'e1',  title: 'IB Mock Exam — Mathematics',      date: '2026-05-07', type: 'exam' },
  { id: 'e2',  title: 'Extended Essay Final Draft Due',   date: '2026-05-10', type: 'deadline' },
  { id: 'e3',  title: 'Robotics Club Session',            date: '2026-05-12', type: 'cca' },
  { id: 'e4',  title: 'Homestay Fee Payment',             date: '2026-05-13', type: 'finance' },
  { id: 'e5',  title: 'AMC Registration Deadline',        date: '2026-05-13', type: 'deadline' },
  { id: 'e6',  title: 'IB Mock Exam — Physics',           date: '2026-05-20', type: 'exam' },
  { id: 'e7',  title: 'Volunteer Day — Geylang CC',       date: '2026-05-22', type: 'cca' },
  { id: 'e8',  title: 'UCAS Personal Statement Draft',    date: '2026-05-28', type: 'deadline' },
  { id: 'e9',  title: 'SAT Exam (June sitting)',          date: '2026-06-07', type: 'exam' },
  { id: 'e10', title: 'Term 3 Fees Due',                  date: '2026-06-01', type: 'finance' },
  { id: 'e11', title: 'Science Olympiad Qualifier',       date: '2026-06-14', type: 'cca' },
  { id: 'e12', title: 'CCA Leadership Handover',          date: '2026-06-20', type: 'cca' },
]
...
function AddEventModal({ onAdd, onClose }: { onAdd: (e: CalEvent) => void; onClose: () => void }) {
...
export default function CalendarPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {showModal && <AddEventModal onAdd={ev => setEvents(p => [...p, ev])} onClose={() => setShowModal(false)} />}
    </div>
  )
}
