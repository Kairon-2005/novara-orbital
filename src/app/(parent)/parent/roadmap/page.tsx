...
import {
  MOCK_MILESTONES, MOCK_CHILD_PROFILE, MOCK_ACHIEVEMENTS,
...
export default function ParentRoadmapPage() {
  ...
  const xp    = computeXP(achievements, milestones, MOCK_DOCUMENTS)
  const level = getLevelInfo(xp)
  const badges = computeBadges(achievements, milestones, MOCK_DOCUMENTS)
